...
const ItemDetail = (props) => {
  ...
  return (
    <>
      ...
      <Header />
      <div className="contents max-w-[1400px] m-auto">
        <div className="shop-container h-[140px] max-w-[1400px] m-auto bg-gray-50">
                  ...
                  <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                    <div className="px-4 py-5 flex-auto">
                      <div className="tab-content tab-space">
                        ...
                        >
                          <p>
                            Going forward knowledge is power or we need to
                            button up our approach old boys club. Please use
                            ...
                            data-point work flows , nor critical mass, and time
                            to open the kimono yet move the needle. You better
                            eat a reality sandwich before you walk back in that
                            ...
                            traction product management breakout fastworks we
                            just need to put these last issues to bed, or table
                            the discussion.
                          </p>
                        </div>
                        <div
