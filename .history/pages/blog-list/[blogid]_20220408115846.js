          ...
          <div className=" blog-articles mt-[10px] col-span-2">
            ...
            <div className="h-[560px] lg:h-[500px] pt-[60px] pr-[30px] pl-[160px] -z-0 w-auto rounded shadow-box-sh">
              ...
              <form className="space-y-4 text-gray-700 px-6" action="/">
                <div className="w-full shadow-box-sh">
                  <textarea
                    id="message"
                    rows="4"
                    className="textarea  border-none rounded-[12px] focus:border-none"
                    placeholder="Your Message"
                  ></textarea>
                </div>

                <div className="flex md:flex h-auto   w-full flex-wrap -mx-2 justify-between space-y-4 md:space-y-0">
                  <div className="name shadow-box-sh">
                    <input
                      className="w-full  p-[20px] rounded-[12px] focus:outline-none  "
                      type="text"
                      placeholder="Your Name"
                      id="formGridCode_name"
                    />
                  </div>
                  <div className="email shadow-box-sh">
                    <input
                      className="w-full p-[20px]  rounded-[42px] focus:outline-none  "
                      type="text"
                      placeholder="Email Address"
                      id="formGridCode_last"
                    />
                  </div>
                  <div className="website shadow-box-sh  ">
                    <input
