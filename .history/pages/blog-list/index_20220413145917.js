  ...
  return (
    <div>
      ...
      <div className="blog-content  xl:mx-[150px]">
        <div className="grid grid-flow-row-dense mt-[30px] max-w-[1400px] m-auto grid-cols-3 gap-4">
              ...
              return (
                <Blogbody
                  ...
                  href={{
                    ...
                    query: { slug: blogList.id.toString() },
                  }}
                />
              );
            })}
        ...
        <div className="pagination inline-flex max-w-[1400px] m-auto ml-[30px]">
          <button>
