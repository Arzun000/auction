...
function blogDetail(props) {
  ...
  return (
    <div>
      <Header />
      <div className="shop-container h-[140px] max-w-[1400px] m-auto rounded-xl shadow-sm">
      ...
      <div className=" blog-content max-w-[1400px] m-auto">
        <div className="grid grid-flow-row-dense mt-[30px]  grid-cols-1 lg:grid-cols-3 gap-4">
          <div className=" blog-articles mt-[10px] col-span-2">
            ...
            <div className="h-[560px] lg:h-[500px] pt-[60px] pr-[30px] pl-[80px] -z-0 w-auto rounded shadow-box-sh">
              ...
              <form className="space-y-4 text-gray-700 px-6" action="/">
                <div className="w-full ">
                  <textarea
                    id="message"
                    rows="4"
                    className="textarea  border-none rounded-[16px] shadow-box-sh focus:border-none"
                    placeholder="Your Message"
                  ></textarea>
                </div>

                <div className="flex md:flex h-auto   w-full flex-wrap  justify-between space-y-4 md:space-y-0">
                  <div className="name ">
                    <input
                      className="w-full  p-[10px] rounded-[16px] shadow-box-sh focus:outline-none  "
                      type="text"
                  ...
                  <div className="website  ">
                    <input
                      className="w-full p-[20px] rounded-[16px] shadow-box-sh focus:outline-none  "
                      type="text"
                ...
                <div className="flex flex-wrap mr-auto"></div>
                <button
                  type="submit"
