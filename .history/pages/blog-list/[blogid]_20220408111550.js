              ...
              <div className="comments md:flex items-center bg-[#2a93da]  h-auto   w-full ">
                ...
                <div className="commenter">
                  ...
                  <div className="comment-content">
                    dfsadfds?’ the answer seems simple. Surely it was the
                    dedication and enthusiasm of Enzo Ferrari? But there is more
                    to the story of these supercars than one man and, from the
                    iconic logo to being backed by Fiat, these are the reasons
                    Ferrari has always stayed on top. In the world of motoring,
                    there is no logo so iconic as Ferrari’s Prancing Horse.
                    Audi’s 4 rings come close, as does Mercedes’ three-pronged
                    star, but the equine emblem of Italy’s foremost supercar
                    manufacturer is in a league of its own. And this level of
                    brand recognition is the first reason that Ferrari is one of
                    the world’s most powerful brands. Enzo Ferrari told the
                    story of this logo just once. “The horse was painted on the
                    fuselage of the fighter plane of Francesco Baracca,” said
                    the automaker, “a heroic airman of the f
                  </div>
                </div>
              </div>
            </div>
