...
export default function shop(props) {
  ...
  return (
    <>
      <Header />
      {/* <Testpage /> */}
      <div className="grid grid-cols-1 max-w-[1400px] m-auto mt-[60px] lg:grid-cols-4 lg:grid-rows-4 lg:grid-flow-col gap-4">
        <div className="col-span-1 row-span-4 bg-gray-50 ">
          <Shopleftnav />
        </div>
        <div className="col-span-3 h-[100px] rounded-xl mt-[20px]  shadow-sh-search1">
          <div className="grid grid-cols-5 gap-4">
            ...
            <div class="col-end-6 col-span-2 mt-[30px] mb-[30px] mr-[20px] ">
        ...
        <div className="row-span-3 col-span-3 mt-[-270px] gap-4">
