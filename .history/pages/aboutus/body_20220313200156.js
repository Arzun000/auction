  ...
  return (
    <div>
      <div className="canv-top-container flex flex-end bg-green-200">
        ...
        <div className="main-content-title absolute bg-white mt-[300px] pr-[48px] pb-[48px] pt-[40px] pl-[50px] w-[50%] ml-[690px] ">
          <div>
            <p className="font-sans-serif text-[36px] text-bold ml-[20px] md:text-[42px]">
              ABOUT US
            </p>
          </div>
