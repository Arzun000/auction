...
export const Content = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 py-[70px] px-[10px] bg-[#F9F9F9]">
      <div className="info ">
        <div className="m-[15px] bg-white text-[#484848] rounded-[30px] p-[5px] font-[300] ">
      ...
      <div className="grid grid-cols-2 pl-[40px] pr-[100px] gap-1">
        <div>
        ...
        <div>
          <div className="inline-flex">
            <div className="py-[10px]">
              <img src="/aboutus/icons/money.png" height={50} width={50}></img>
            </div>
            <div className="feature-text mt-[5px] ml-[30px]">
