  ...
  return (
    <div>
      <div className="canv-top-container flex flex-end bg-green-200">
        ...
        <div className="main-content-title absolute bg-white mt-[300px] pr-[48px] pb-[48px] pt-[40px] pl-[50px] w-[50%] ml-[850px] mr-[20px]">
          <div>
            <p className="font-sans-serif text-[36px] md:text-[42px]">
              ABOUT US
            </p>
          </div>
          <div className="text-justify text-[#484848] text-[1rem] font-[300]">
            <p>
