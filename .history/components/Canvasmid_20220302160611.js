    ...
    <>
      ...
      <canvasmidcards>
        <div className="canvas-cards">
          <div class="grid inline-flex grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6 p-5 pb-6">
            <div className="h-[250px] bg-blue-200 w-150">
              <img
                class="object-fill h-full w-full"
                src="/images/car1.jpg"
              ></img>
              <div className="image-texts absolute bg-green-200 ">
                <div className="bid-now">d</div>
                <div className="add">s</div>
                <div className="view">aa</div>
              </div>
            </div>
