...
export const Testpage = () => {
  return (
    <div className="lg:flex grid-cols-1 lg:grid-cols-2 flex-row mt-[10px] gap-[20px] mx-[40px] mb-[40px]">
      <div
        className="w-[50%] h-[400px] mt-[20px]  bg-cover bg-center  "
        style={{
      ...
      >
        <div className={Styles.svgwrapper}>
          <svg height="80%" width="650" xmlns="http://www.w3.org/2000/svg">
            <line
