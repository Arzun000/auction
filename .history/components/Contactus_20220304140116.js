    ...
    <>
      <canvasmid>
        ...
        <div className="grid grid-cols-1  lg:grid-cols-2 gap-2">
          ...
          <container-form>
            <div className="contact-form p-12">
              <form class="space-y-4 text-gray-700 px-6">
                <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0">
                  <div class="w-full px-2 md:w-1/2">
                    ...
                    <input
                      class="w-full h-10 px-3 border-b-[1px] border-[#898a85] focus:outline-none focus:bg-white focus:border-purple-500 focus:border-b-[#ea7f23] focus:border-b-[5px] "
                      type="text"
                  ...
                  <div class="w-full px-2 md:w-1/2">
                    ...
                    <input
                      class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg"
                      type="text"
