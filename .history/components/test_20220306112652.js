    ...
    <>
      <div className="top-container ">
        <div className="container m-auto py-2 flex  md:flex-row">
          ...
          <div className="container-search mt-20 h-auto shadow-sh-search inline-flex m-auto">
            <div className="cat-list w-auto inline-flex  ">
              <div className="cat-list ">
                <div className="dropdown-button h-12  w-50 pt-2 pl-2 pr-2 border-r-4 bg-white rounded-l-lgx">
              ...
              <div className="cat-search inline-flex bg-red-500 rounded-r-lgx">
                <div className="search-pro bg-white h-12 w-80 border-gray-200 flex items-center rounded-r-lgx">
                  <input
                    type="text"
                ...
                <div className="search-btn  rounded-r-lgx">
                  <button
