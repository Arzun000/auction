...
export const Footer = () => {
  return (
    <>
      ...
      <footer-links>
        <div className="footer-link-container grid bg-[#eabb23] mt-[1px] h-[120px] grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 w-full">
          <div className="contact-info flex-col bg-[#12bb23]">
            <div className="container-logo  m-auto p-2 ">
              <img
