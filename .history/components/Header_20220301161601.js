    ...
    <>
      <topheader>
        <div className="header-top bg-slate-500 h-10">
          <div className="container m-auto my-px flex bg-yellow-500 md:flex-row   ">
            <div className="row-top-header items-center">
              <div className="flex flex-row ">
                <div className="language-box w-20 items-center inline-flex">
                  EN
                  <img
                ...
                <div className="currency-box w-20 items-center inline-flex">
                  EUR
                  <img
                    src="/static/icons/expand_arrow.png"
                    height={15}
