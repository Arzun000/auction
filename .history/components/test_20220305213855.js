  ...
  return (
    <>
      <div className="header-top w-full px-[70px] bg-gray-100 inline-flex">
        <div className="header-top-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-4 w-full bg-yellow-100">
          <div className="top-cont-left lg:inline-flex px-[2px] col-span-3 bg-blue-400 py-[5px] gap-1">
          ...
          <div className="bg-gray-500 py-[10px] h-auto">
            <div class="flex md:flex-row-reverse flex-wrap">
              ...
              <div class="w-auto md:w-1/4 bg-gray-400  text-center text-gray-700"></div>
            </div>
          </div>
        </div>
      </div>
