...
export const Test = () => {
  return (
    <>
      ...
      <canvasmidcards>
        <div className="grid grid-cols-1 h-[200px] md:flex-row md:grid-cols-2 lg:grid-cols-4 gap-2">
          {/* <item1> */}

          <div className="items-container-1 p-2">
            <div>
          ...
          <div>
            <div className="items-container-2 p-2">
              <div>
          ...
          <div>
            <div className="items-container-3 p-2">
              <div>
                <img src="/images/car3.jpg"></img>
              </div>
              <div className="canv-container absolute flex mt-[-200px]">
                <div className="image-icons ml-6 ">
                  <div className="bid-now-icon rounded-full ">
          ...
          <div>
            <div className="items-container-4 p-2">
              <div>
                <img src="/images/car4.jpg"></img>
              </div>
              <div className="canv-container absolute flex mt-[-200px]">
                <div className="image-icons ml-6 ">
                  <div className="bid-now-icon rounded-full ">
