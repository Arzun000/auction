          ...
          <div className="canv-container absolute top-[25rem] left-[5rem] bg-green-200 flex  h-[16rem] w-[30rem] ">
            <div className="canv-content ">
              ...
              <button class="inline-flex items-center focus:outline-none text-base md:mt-2 ">
                <div className="main-content-btn bg-blue-200 border border-black w-[120px] rounded-lgx ">
                  <div
                    className="auc-btn font-medium text-black 
                    rounded-lgx hover:bg-yellow-500 hover:border-yellow-500:border:border-yellow-500 focus:ring p-2
                     "
                  >
                    View Auctions
                  </div>
