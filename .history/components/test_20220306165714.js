    ...
    <>
      <div className="navbar bg-[#ea7f23]">
        <div className="container navbar  m-auto flex  md:flex-row">
          ...
          <div className="header-links ml-[2px] hidden md:mr-auto md:ml-4 md:py-1 md:pl-4 float-left lg:inline-flex m-auto">
            <a href="#" class="mr-5 no-underline  hover:text-yellow-900">
              Home
            </a>
