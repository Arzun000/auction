  ...
  return (
    <div>
      <div className="canv-top-container flex flex-end ">
        ...
        <div className="main-content-title absolute bg-white z-10 mt-[150px] pr-[48px] pb-[48px] pt-[40px] pl-[50px] w-[50%] ml-[690px] ">
          <div>
            <p className="font-sans-serif text-[36px] font-bold ml-[20px] md:text-[42px]">
              ABOUT US
            </p>
          </div>
          <div className="text-justify text-[#484848] bg-slate-300 text-[14px] m-[17px] font-[300]">
            <p>
