...
export const Body = () => {
  return (
    <div>
      <div className="canv-top-container flex flex-end -z-30">
        <img src="/aboutus/about_business1.jpg"></img>
        <div className="main-content-title absolute bg-slate-300 z-1 mt-[150px] pr-[48px] pb-[48px] pt-[40px] pl-[50px] w-[50%] ml-[690px] ">
          <div>
