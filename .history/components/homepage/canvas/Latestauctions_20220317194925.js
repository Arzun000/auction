...
export const Latestauctions = () => {
  return (
    <>
      <canvasmid>
        <div className="mid-canvas mb-[20px]">
        ...
        <div className="canvas-cards pb-[30px] px-[20px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[65px] md:gap-4 lg:gap-4 ">
            ...
            <div className="h-[250px] overflow-hidden shadow-xl">
              ...
              <div className="image-caption w-[334px] shadow-xl absolute bg-white text-center ">
            ...
            > */}
              ...
              <div className="image-caption w-[334px] absolute shadow-xl text-center ">
                <div className="image-caption-one text-xl font-bold">
                  <a href="#" className="no-underline">
                    Item Info
                  </a>
            ...
            > */}
              ...
              <div className="image-caption w-[334px] absolute text-center shadow-xl">
                <div className="image-caption-one text-xl font-bold">
                  <a href="#" className="no-underline">
                    Item Info
                  </a>
