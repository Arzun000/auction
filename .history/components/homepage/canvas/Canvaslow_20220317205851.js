...
export const Canvaslow = () => {
  return (
    <>
      <canvaslow>
        <div className="canvas-low-cards mt-[80px]">
              ...
              ></img> */}
                <div className="image-caption absolute text-center mt-[-250px] ml-[60px] ">
                  ...
                  <div className="ml-[-120px]">
                    <button
                      type="button"
                      className="py-2.5 px-5 mb-2 text-sm  text-white rounded-full border-[2px] border-grey-400
           hover:bg-white hover:border-yellow-500 hover:text-[#ea7f23] font-bold focus:z-10 focus:ring-2 focus:ring-blue-700
            focus:text-blue-700"
                    >
                      VIEW MORE
                    </button>
