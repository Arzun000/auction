...
export const Canvaslow = () => {
  return (
    <>
      <div className="lg:flex grid-cols-1 lg:grid-cols-2 flex-row gap-5 mt-[10px] mb-[40px]">
        <div className="car1 mt-[20px] ml-[10px] relative lg:w-[50%] bg-green-800 ">
          <div className="car-img">
            <img
              className="w-full object-cover h-[400px]"
              src="/images/supercar1.jpg"
            ></img>
            <div className="snake-border opacity-0 hover:opacity-100 z-10 absolute h-[340px] w-[90%] mt-[-370px] ml-[30px] "></div>
            <div className="image-caption absolute text-center z-10 mt-[-250px] ml-[60px] ">
        ...
        <div className="car1 mt-[20px] mr-[10px] relative lg:w-[50%] bg-green-800 ">
          <div className="car-img">
            <img
              className="w-full object-cover h-[400px]"
