    ...
    <>
      ...
      <canvasmidcards>
        <div className="canvas-cards pb-[30px] px-[20px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[65px] md:gap-[65px] lg:gap-[65px] ">
            {/* Item 1 */}
            <div className="shadow-xl">
              ...
              style={{
                ...
                <div className="image-caption w-[340px] shadow-xl absolute bg-white text-center ">
