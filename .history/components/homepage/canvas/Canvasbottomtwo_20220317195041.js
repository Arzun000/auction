...
export const Canvasbottomtwo = () => {
  return (
    <>
      <canvas-bottom>
        <div className="can-btm-container mt[80px]">
          <div className="grid md:grid-rows-2 md:grid-cols-3 md:grid-flow-col gap-4 p-2">
            {/* image 1 */}
           ...
           hover:bg-yellow-500 hover:border-yellow-500 hover:text-white focus:z-10 focus:ring-2 focus:ring-blue-700
            ...
            {/* image-2 */}
            <div className="col-span-1 h-auto relative shadow-box-sh w-auto">
            ...
            {/* item 3 */}
            <div className="col-span-1 shadow-box-sh">
              <div className="h-[175px] inline-flex">
                <div className="image w-[180px] m-auto pl-2">
                  <img
