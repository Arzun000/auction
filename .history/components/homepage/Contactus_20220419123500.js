  ...
  return (
    <>
      <div className="contactus mt-[60px] max-w-[1400px] m-auto">
        ...
        <div className="grid grid-cols-1 mt-[60px] lg:grid-cols-2 gap-2">
          <container-map>
            <div className="map">
          ...
          <container-form>
            <div className="contact-form bg-white p-6 h-auto lg:h-[450px]  rounded shadow-2xl">
              <form className="space-y-4 text-gray-700 px-6" action="/">
                ...
                <div className="flex flex-wrap">
                  <div className="w-full">
                    <label
                      for="message"
                      className="block mb-2 text-sm  dark:text-gray-400"
                    >
                      Your message
                    </label>
                    <textarea
