  ...
  return (
    <div>
      <div className="grid grid-cols-1 ml-[20px] mt-[140px] lg:grid-cols-4 lg:grid-rows-4 lg:grid-flow-col gap-4">
        ...
        <div className="col-span-3 h-[120px] rounded shadow-sh-search1">
          <div className="grid grid-cols-5 gap-4">
            <div class="col-start-1 col-end-3 mt-[40px] ml-[40px] inline-flex shadow-sh-search1 ">
              <div className="ml-[10px] shadow-sh-search1 h-[14px]">
                <button className="view-icon shadow-sh-search1">
            ...
            <div class="col-end-6 col-span-2 mt-[40px] mr-[20px] ">
