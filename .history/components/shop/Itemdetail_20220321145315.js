      ...
      <div className="grid grid-cols-2 gap-4 mr-[120px] mt-[120px] bg-red-300 ml-[120px]">
        ...
        <div className="bg-green-200">
          ...
          <div className="pro-info">
            <div className="">Item Condition: Used</div>
            <div className="">Auction ended: August 5, 2021</div>
            <div className=""></div>
            <div className="">
              SKU: MT034 Categories: V12, SuperCar, 1.999cm3, Self-driving Tags:
              sales, black friday, hot
            </div>
          </div>
        </div>
      </div>
