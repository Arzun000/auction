      ...
      <div className="grid grid-cols-1 ml-[20px] mt-[120px] lg:grid-cols-4 lg:grid-rows-4 lg:grid-flow-col gap-4">
        ...
        <div className="col-span-3 bg-blue-400 h-[120px] ">
          <div className="grid grid-cols-5 gap-4">
            <div class="col-start-1 col-end-3 mt-[20px] bg-blue-800">
              <div className="view-icon inline-flex">
                <img src="/static/icons/grid.png" height={15} width={15}></img>

                <img src="/static/icons/list.png" height={15} width={15}></img>
              </div>
            </div>
