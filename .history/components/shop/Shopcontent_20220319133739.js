        ...
        <div className="col-span-1 row-span-4 bg-gray-50 ">
          ...
          <div className="left-nav-title">
            ...
            <div className="cat-search  inline-flex">
              ...
              <form className="search-pro1 text-[14px] mt-[10px] bg-white h-[40px] w-[250px] shadow-sh-search1 border-black-200 focus:outline-none flex rounded-lgx items-center">
                {/* <div className="input-text"> */}
                <input
                  type="text"
