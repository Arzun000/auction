      ...
      <div className="grid grid-cols-1 ml-[20px] mt-[120px] lg:grid-cols-4 lg:grid-rows-4 lg:grid-flow-col gap-4">
        ...
        <div className="col-span-3 bg-blue-400 h-[120px] ">
          <div className="grid grid-cols-6 gap-4">
            ...
            <div class="col-end-7 col-span-2 mt-[20px] mr-[20px] bg-green-800">
              <div className="dropdown-button bg-yellow-200 items-center py-[8px] shadow-sh-search1 rounded-l-lgx">
