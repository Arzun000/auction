        ...
        <div className="col-span-1 row-span-4 bg-gray-50 ">
          ...
          <div className="left-nav-title">
            ...
            <div className="cat-search  inline-flex">
              ...
              {/* <form className="example m-auto mt-[10px]" action="">
                <input type="text" placeholder="Search.." name="search2" />
                <button type="submit">
                  <img
                    className="iconbutton absolute mt-[-120px] ml-[-40px] bg-yellow-200"
                    src="/static/icons/search.png"
                    height={30}
                    width={30}
                  ></img>
              ...
              <form className="search-pro1 text-[14px] mt-[10px] bg-white h-[40px] w-[250px] shadow-sh-search1 border-black focus:outline-none flex rounded-lgx items-center">
                {/* <div className="input-text"> */}
                <input
                  type="text"
                  placeholder="Search Auctions..."
                  className="bg-transparent text-[#cecece] border-black-200 text-[14px] w-full px-4 focus:outline-none"
                  //className="input-text1"
                />
