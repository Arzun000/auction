      ...
      <div className="grid grid-cols-1 ml-[20px] mt-[140px] lg:grid-cols-4 lg:grid-rows-4 lg:grid-flow-col gap-4">
        ...
        <div className="row-span-3 bg-red-400 col-span-3 mt-[-290px] gap-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-[20px] gap-y-[100px]">
            ...
            <div className="bg-green-400 overflow-hidden h-[300px]">
              <div class={Styles.articleimgholder}></div>
              <div className="bg-white absolute ">
                <div className="image-caption w-[360px] md:w-[235px] lg:w-[336px] shadow-xl absolute bg-white text-center h-[80px] pt-[10px]">
                  <div className="cardtext">
                    <a href="#" className="no-underline">
                      <b>White Car</b>
                    </a>
