...
export const Shopcontent = () => {
  return (
    <div>
      <div className="grid flex grid-cols-1 lg:grid-cols-2 lg:grid-rows-4 lg:grid-flow-col gap-4">
        <div className="row-span-4 bg-green-400 w-[129px]">01</div>
        <div className="col-span-2 flex-grow bg-green-400">02</div>
        <div className="row-span-1 grow col-span-2 ">
