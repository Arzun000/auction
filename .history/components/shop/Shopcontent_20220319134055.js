        ...
        <div className="col-span-1 row-span-4 bg-gray-50 ">
          ...
          <div className="left-nav-title">
            ...
            <div className="cat-search  inline-flex">
              <form className="search-pro1 text-[14px] mt-[10px] bg-red-200 h-[40px] w-[250px] shadow-sh-search1 border-red-700 focus:outline-none flex rounded-lgx items-center">
