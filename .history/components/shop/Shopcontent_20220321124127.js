          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-[20px] gap-y-[120px]">
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                ...
                style={{
                  background: "url('/images/car1.jpg'), BackgroundSize:contain",
                }}
              ></div>
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                className={Styles.articleimgholder}
                style={{ background: "url('/images/car3.jpg')" }}
              ></div>
              <div className="bg-white absolute ">
                <Iconsverticalbid />
                <div className="cardtext w-[420px] md:w-[235px] lg:w-[336px] shadow-xl absolute text-center h-[80px] pt-[10px]">
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                className={Styles.articleimgholder}
                style={{ background: "url('/images/car4.jpg')" }}
              ></div>
              <div className="bg-white absolute ">
                <Iconsverticalbid />
                <div className="cardtext w-[420px] md:w-[235px] lg:w-[336px] shadow-xl absolute text-center h-[80px] pt-[10px]">
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                className={Styles.articleimgholder}
                style={{ background: "url('/images/car5.jpeg')" }}
              ></div>
              <div className="bg-white absolute ">
                <Iconsverticalbid />
                <div className="cardtext w-[420px] md:w-[235px] lg:w-[336px] shadow-xl absolute text-center h-[80px] pt-[10px]">
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                className={Styles.articleimgholder}
                style={{ background: "url('/images/car6.jpg')" }}
              ></div>
              <div className="bg-white absolute ">
                <Iconsverticalbuy />
                <div className="cardtext w-[420px] md:w-[235px] lg:w-[336px] shadow-xl absolute text-center h-[80px] pt-[10px]">
                  <a href="#" className="no-underline">
                    <b>Green Vintage Car</b>
                  </a>
                  <subtext>
                    <p>
                      Price: <b>$12000</b>
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                className={Styles.articleimgholder}
                style={{ background: "url('/images/car7.jpg')" }}
              ></div>
              <div className="bg-white absolute ">
                <Iconsverticalbid />
                <div className="cardtext w-[420px] md:w-[235px] lg:w-[336px] shadow-xl absolute text-center h-[80px] pt-[10px]">
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                className={Styles.articleimgholder}
                style={{ background: "url('/images/car8.jpg')" }}
              ></div>
              <div className="bg-white absolute ">
                <Iconsverticalbid />
                <div className="cardtext w-[420px] md:w-[235px] lg:w-[336px] shadow-xl absolute text-center h-[80px] pt-[10px]">
                  <a href="#" className="no-underline">
                    <b>Spoiler Ferrrari</b>
                  </a>
                  <subtext>
                    <p>
                      Current Bid: <b>$12000</b>
                    </p>
                  </subtext>
                </div>
              </div>
            ...
            <div className=" overflow-hidden h-[300px]">
              <div
                className={Styles.articleimgholder}
                style={{ background: "url('/images/car9.jpg')" }}
              ></div>
              <div className="bg-white absolute ">
                <Iconsverticalbuy />
                <div className="cardtext w-[420px] md:w-[235px] lg:w-[336px] shadow-xl absolute text-center h-[80px] pt-[10px]">
                  <a href="#" className="no-underline">
                    <b>Sky Blue Ferrari</b>
                  </a>
                  <subtext>
                    <p>
                      Price: <b>$8000</b>
