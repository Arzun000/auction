        ...
        <div className="col-span-1 row-span-4 bg-gray-50 ">
          ...
          <div className="left-nav-title">
            ...
            <div className="cat-search  inline-flex">
              <form className="search-pro1 text-[14px] bg-white h-[40px] shadow-sh-search1 mt-[10px] rounded-lgx items-center">
                {/* <div className="input-text"> */}
                <input
                  type="text"
                  placeholder="Search Products..."
                  className="bg-transparent text-[#cecece] text-[14px] w-full px-4 items-center focus:outline-none"
