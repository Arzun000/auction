        ...
        <div className="col-span-1 row-span-4 bg-gray-50 ">
          ...
          <div className="left-nav-title">
            ...
            <div className="cat-search  inline-flex">
              <form className="search-pro1 bg-red-900 h-auto shadow-sh-search1 mt-[10px] rounded-lgx ">
                {/* <div className="input-text"> */}
                <input
                  type="text"
                  placeholder="Search Products..."
                  className="bg-transparent text-[#cecece] text-[14px] w-full p-[8px] focus:outline-none"
