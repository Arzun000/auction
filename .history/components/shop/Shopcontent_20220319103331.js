...
export const Shopcontent = () => {
  return (
    <div>
      <div className="grid grid-cols-1 absolute lg:grid-cols-2 lg:grid-rows-2 lg:grid-flow-col gap-4">
        <div className="row-span-4 bg-green-400 w-[120px] ">01</div>
        <div className="col-span-1 absolute bg-blue-400 h-10  w-[800px]">
          02
        </div>
