    ...
    <>
      <div className="header-top w-full px-[70px] inline-flex">
        <div className="header-top-container grid md:grid-cols-2 lg:grid-cols-4 md:gap-0 w-full bg-yellow-100">
          {/* <div className="top-cont-left lg:inline-flex px-[2px] h-auto col-span-3 bg-blue-400 py-[2px] gap-1"> */}
          ...
          <div className="w-auto  bg-gray-500 h-12">gg</div>
          <div className="w-auto  bg-gray-500 h-12">dd</div>
          {/* </div> */}
