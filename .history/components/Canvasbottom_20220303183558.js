            ...
            <div class="col-span-1 h-auto bg-yellow-400 w-auto">
              <div className="h-[175px]  inline-flex">
                <img
                  ...
                  className="object-fill h-full w-full"
                ></img>
                <div className="image-caption text-center col-end mt-[30px] ml-[275px]">
                  <div className="image-caption-one relative text-xl font-bold">
                    <p>VolksWagan Bus</p>
                  </div>
                  <div className="image-caption-two pb-2">Auction Ended</div>
                </div>
                <div className="image-texts h-[40px] w-[150px] bg-green-400 relative inline-flex ">
