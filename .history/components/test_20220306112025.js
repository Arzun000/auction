    ...
    <>
      <div className="top-container ">
        <div className="container m-auto py-2 flex  md:flex-row">
          ...
          <div className="container-search mt-10 h-[120px] pt-[20px] bg-blue-300 inline-flex m-auto">
            <div className="cat-list w-auto inline-flex ">
              <div className="cat-list pt-4  ">
                <div className="dropdown-button h-12 shadow-2xl w-50 pt-2 pl-2 pr-2 border-r-4 bg-white rounded-l-lgx">
