      ...
      <div className="container m-auto py-2 flex text-[#334141] text-[14px] font-[400] md:flex-row">
        <div className="container-logo inline-block relative p-2 ">
          <div class="group inline-block relative">
            ...
            <ul class="absolute hidden bg-white  shadow-sh-search text-gray-700 pt-1 pr-8 group-hover:block">
              <li class="">
                <a
                  class="rounded-t hover:bg-gray-400 py-2 w-full px-4 block whitespace-no-wrap"
                  href="#"
                >
                  EN
                </a>
