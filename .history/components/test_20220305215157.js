  ...
  return (
    <>
      <div className="header-top w-full px-[70px] bg-gray-100 inline-flex">
        <div className="header-top-container grid grid-cols-1 lg:grid-cols-4 md:gap-0 w-full bg-yellow-100">
          <div className="top-cont-left lg:inline-flex px-[2px] lg:col-span-3 bg-blue-400 py-[2px] gap-1">
