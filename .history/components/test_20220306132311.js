    ...
    <>
      <div className="top-container ">
        <div className="container m-auto py-2 flex  md:flex-row">
          ...
          <div className="search-container h-[auto] w-[auto]  py-4 inline-flex">
            <div className="dropdown-button h-auto items-center pl-2 pr-2 bg-green-500 pt-[15px] shadow-sh-search1 rounded-l-lgx">
            ...
            <div className="search-pro bg-white h-auto w-80 shadow-sh-search border-gray-200 flex  items-center">
              <input
                type="text"
