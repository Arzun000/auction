          ...
          <div className="container navbar  m-auto flex  md:flex-row">
            ...
            <div className="header-links ml-[2px] hidden text-white md:mr-auto md:ml-4 md:pl-4 float-left lg:inline-flex m-auto">
              <div class="group inline-block  relative">
                <button class="text-white  font-semibold h-[60px] pr-4 inline-flex items-center">
                  Home
                </button>
                <div class="absolute inset-0 transform hover:-translate-y-[10px] mt-[120px] transition duration-300">
                  <ul class="absolute hidden bg-white shadow-sh-search w-[180px] text-center text-gray-700 group-hover:block ">
                    <li className=" px-4 pt-6 font-sans font-bold">DEMOS</li>
                    <li class="">
                      <a
                ...
                <ul class="absolute hidden bg-white shadow-sh-search w-[600px] ease-in-out duration-1000 text-center text-gray-700 group-hover:block">
                  <div className="inline-flex">
                    <div className="shop-menu-left">
                      <li className=" px-4 pt-6 font-sans font-bold">
                        IT & Computer
                      </li>
                      <li class="">
                        <a
                    ...
                    <div className="shop-menu-right">
                      {" "}
                      <li className=" px-4 pt-6 font-sans font-bold">PHONES</li>
                      <li class="">
                        <a
                          class="hover:text-[#ea7f23] py-2 px-4 block whitespace-no-wrap"
                          href="#"
