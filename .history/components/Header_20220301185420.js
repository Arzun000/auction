...
export const Header = () => {
  return (
    ...
    <>
      ...
      <top-container>
        <div className="container-top bg-green-500 h-10">
          <div className="container-items inline-flex">
            <div className="container-logo">
              <img src="/static/logo-ibid.png" height={250} width={250}></img>
            </div>
            <div className="container-search">s</div>
