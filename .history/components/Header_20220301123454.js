    ...
    <>
      <header className="text-gray-600 body-font h-3.5">
        <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center bg-[#ea7f23] ">
          <div className="dropdown-button h-12 w-24 pl-1 bg-gray-100">
            <button class="inline-flex items-center  border-0 content-center focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
              Button
              <svg
                fill="none"
                stroke="currentColor"
