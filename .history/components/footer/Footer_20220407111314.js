      ...
      <div className="footer-large hidden  md:block">
        <footer-search>
          <div className=" mx-[5%] lg:py-4 ">
            <div className="hidden md:items-center md:justify-between md:inline-flex bg-[#ea7f23] py-[20px] h-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 w-full"></div>
          </div>
