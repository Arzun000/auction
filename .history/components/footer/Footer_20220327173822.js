  ...
  return (
    <>
      <div className="footer-large hidden md:block">
        <footer-search>
          <div className="footer-search-container hidden md:block bg-[#ea7f23] py-[20px] h-auto p-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 w-full">
        ...
        <footer-links>
          <div className="footer-link-container grid bg-[#f9f9f9] pt-[30px] h-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 w-full">
      ...
      <div className="small-footer md:hidden">
        <div className="small-footer-content bg-slate-300 m-auto py-[10px] w-[1/4]">
        ...
        <div className="small-footer-content bg-red-500 m-auto w-[1/4]">dd</div>
        <div className="small-footer-content bg-slate-300 m-auto w-[1/4]">
          dd
        </div>
        <div className="small-footer-content bg-slate-300 m-auto w-[1/4]">
          dd
