    ...
    <>
      <div className="footer-large hidden  md:block">
        <footer-search>
          <div className="bg-[#ea7f23] py-[20px] px-[5%]  lg:py-4 ">
            <div className="hidden md:flex md:items-center md:justify-between max-w-[1400px] m-auto h-auto   w-full">
        ...
        <footer-links>
          <div className="py-[20px] max-w-[1400px] m-auto  lg:py-4 ">
            <div className="hidden md:flex md:items-center md:justify-between   h-auto   w-full">
              <div className="contact-info ">
                <div className="container-logo ml-[20px] mt-[20px]">
                  <img
                    src="/static/logo-ibid.png"
                    height={150}
                    width={150}
                  ></img>
                </div>
      ...
      <div className="mt-[80px]">
        <div className="small-footer mt-[90px] md:hidden divide-x divide-gray-200">
          ...
          <div className="small-footer-content bg-green-200 flex mx-auto py-[10px] w-[1/4]">
            <button className="m-auto items-center hover:text-[#ea7f23]">
              <div className="mx-[10px] ">
                <img
