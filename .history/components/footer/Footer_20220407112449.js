      ...
      <div className="footer-large hidden  md:block">
        <footer-search>
          <div className="bg-[#ea7f23] py-[20px]  lg:py-4 ">
            <div className="hidden  mx-[5%] md:items-center md:justify-between md:inline-flex bg-[#ea7f23]  h-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-2  w-full">
              <div className="footertxt bg-blue-800">
                <p>Browse through our products library!</p>
              </div>
              <div className="footer-search bg-blue-800 m-auto inline-flex">
