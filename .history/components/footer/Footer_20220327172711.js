  ...
  return (
    <>
      ...
      <div className="small-footer md:hidden">
        <div className="footercontent-1 bg-slate-300 m-auto w-[1/4]">dd</div>
        <div className="footercontent-1 bg-red-500 m-auto w-[1/4]">dd</div>
        <div className="footercontent-1 bg-slate-300 m-auto w-[1/4]">dd</div>
        <div className="footercontent-1 bg-slate-300 m-autow-[1/4]">dd</div>
      </div>
    </>
  );
};
