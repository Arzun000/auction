  ...
  return (
    <>
      <div className="footer-large hidden md:block">
        <footer-search>
          <div className="footer-search-container hidden md:inline-flex bg-[#ea7f23] py-[20px] h-auto p-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 w-full">
      ...
      <div className="small-footer pt-[90px] md:hidden divide-x divide-gray-200">
