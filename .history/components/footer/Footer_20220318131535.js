...
export const Footer = () => {
  return (
    <>
      <footer-search>
        <div className="footer-search-container grid bg-[#ea7f23] pt-[10px] h-auto p-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 w-full">
          <div className="footertxt ">
            <p>Browse through our products library!</p>
          </div>
          <div className="footer-search m-auto">
            <div className="cat-search bg-blue-500 md:ml-[180px] inline-flex">
              <div className="search-pro1 text-[14px] bg-white h-[40px] w-[450px] shadow-sh-search1 border-gray-200 focus:outline-none flex rounded-lgx items-center">
