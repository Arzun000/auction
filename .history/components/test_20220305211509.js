    ...
    <>
      <div className="header-top w-full px-[70px] bg-gray-100 inline-flex">
        <div className="header-top-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full bg-yellow-100">
          <div className="top-cont-left md:flex-col lg:inline-flex px-[2px] col-span-3 bg-blue-400 py-[2px] gap-1">
            <div className="w-[130px] bg-gray-500 py-[10px]  h-12">
            ...
            <div className="w-3/5 bg-gray-400 h-12 invisible md:visible items-center">
