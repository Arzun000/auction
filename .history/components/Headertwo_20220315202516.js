            ...
            <div className="container-search hidden text-[14px] float-left lg:inline-flex m-auto">
              <div className="dropdown-button h-[40px] items-center pl-2 pr-2  pt-[8px] shadow-sh-search1 rounded-l-lgx">
                <button className="inline-flex items-center  focus:outline-none text-base ">
                  <div className="cat text-[14px] ml-6 ">CATEGORIES</div>
              ...
              <div className="search-pro1 text-[14px] bg-white h-[40px] w-[350px] shadow-sh-search1 border-gray-200 focus:outline-none flex rounded-r-lgx items-center">
                {/* <div className="input-text"> */}
                <input
                  type="text"
                  placeholder="Search Products..."
                  className="bg-transparent text-gray-600 text-[14px] w-full px-4 focus:outline-none"
