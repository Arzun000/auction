      ...
      <div className="top-container ">
        <div className="container m-auto py-2 flex  md:flex-row">
          ...
          <div className="search-container h-[auto] w-[auto] py-4 inline-flex">
            <div className="dropdown-button h-12 w-50 pl-2 pr-2 bg-blue-600 rounded-l-lgx">
            ...
            <div className="search-pro bg-gray-100 h-12 w-80 border-gray-200 flex shadow-sh-search items-center">
              <input
                type="text"
