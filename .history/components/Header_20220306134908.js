    ...
    <>
      <topheader>
        <div className="header-top w-full px-[70px] inline-flex">
          <div className="header-top-container grid md:grid-cols-2 lg:grid-cols-4 md:gap-0 w-full ">
            <div className="top-cont-left inline-flex px-[2px] h-auto col-span-3  py-[2px] gap-1">
              <div className="w-[130px]  py-[10px] flex h-[auto]">
              ...
              <div className="w-auto  h-auto  items-center">
                <div className="header-top-contact-methods invisible lg:visible inline-flex py-[10px] ">
                  <div className="header-top-contact-phone hidden lg:visible">
                    Call us toll free: +40 712 345 678
                  </div>
                  <div className="header-top-contact-email  hidden lg:visible mx-4">
                    Send us an email: sale@modeltheme.com
                  </div>
                </div>
              </div>
              <div className="w-auto hidden  ">gg</div>
              <div className="w-auto hidden ">dd</div>
            </div>

            <div className=" py-[10px] h-auto">
              <div class="flex flex-wrap place-content-end pr-2">
                <div class="w-full md:w-auto   text-right text-gray-700">
