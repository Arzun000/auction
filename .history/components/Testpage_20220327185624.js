            ...
            <a>
              <div className=" overflow-hidden h-[300px]">
                ...
                <div className="cardtext bg-white text-center shadow-box-sh absolute mt-[-100px] mx-[20px] w-[280px] p-[10px]">
                  <div className="timer flex flex-wrap">
                    <div className="days w-1/4">
                      <div className="days-no"> 120 </div>
                      <div className="days-txt">days</div>
                    </div>
                    <div className="hours w-1/4">
                      <div className="hours-no"> 120 </div>
                      <div className="hours-txt">days</div>
                    </div>
                    <div className="minutes w-1/4">
                      <div className="minutes-no"> 45 </div>
                      <div className="minutes-txt">minutes</div>
                    </div>
                    <div className="seconds w-1/4">
                      <div className="seconds-no"> 15 </div>
                      <div className="seconds-txt">seconds</div>
                    </div>
                  </div>
                </div>
