      ...
      <div className="header-top w-full px-[70px] bg-gray-100 inline-flex">
        ...
        <div className="header-top-container p-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full bg-yellow-100">
          <div className="top-cont-left inline-flex col-span-2 gap-1">
            <div class="lang-currency w-[100px] inline-flex bg-green-300">
            ...
            <div class="invisible md:visible w-[250px] bg-green-300">
          ...
          <div class="col-start-3 w-[250px] ml-[50px] bg-red-400">03</div>
          <div class=" ...">04</div>
        </div>
      </div>
    </>
