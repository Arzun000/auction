          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6 p-5 pb-6">
            <div className="h-[250px] bg-blue-200 w-150">
              ...
              <img
                ...
                src="/images/car1.jpg"
              ></img>
              <div className="image-caption text-center bg-blue-400">
                <div className="image-caption-one text-3xl font-bold">
                  <a href="#" class="no-underline">
                    Item Info
                  </a>
                </div>
                <div className="image-caption-two">Current Bid: $100</div>
              </div>
            </div>
