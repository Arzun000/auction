        ...
        <div className="top-container  ">
          <div className="container m-auto py-2 flex  md:flex-row">
            ...
            <div className="container-search hidden text-[14px] float-left lg:inline-flex m-auto">
              ...
              <div className="search-pro1 text-[14px] text-[#cecece] bg-white h-[40px] w-[350px] shadow-sh-search1 border-gray-200 focus:outline-none flex rounded-r-lgx items-center">
                {/* <div className="input-text"> */}
                <input
                  type="text"
                  placeholder="Search Products... text-[#cecece]"
