    ...
    <>
      <div className="navbar bg-[#ea7f23]">
        <div className="container navbar  m-auto flex  md:flex-row">
          <div class="hidden md:flex items-center text-white space-x-1">
            <div className="cat-dropdown bg-white p-2.5 pt-[20px]">
              <button
                className=" font-bold uppercase text-sm px-6 outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
                type="button"
                ref={btnDropdownRef}
                onClick={() => {
                  dropdownPopoverShow
            ...
            <div className="navlinks bg-green-400 inline-flex">
              <button>
                <Link href="#">
                  <b>Sign In</b>
                </Link>
