  ...
  return (
    <>
      <div className="navbar bg-[#ea7f23]">
        <div className="container navbar absolute m-auto flex  md:flex-row">
          <div class="hidden md:flex text-white items-center space-x-1">
            ...
            <button>
              <div className="navlinks ml-auto  inline-flex">
                <Link href="#">
                  <b>Sign In</b>
                </Link>
              </div>
