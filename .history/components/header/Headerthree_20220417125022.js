      ...
      <div className={navbarClasses.join(" ")}>
        <div className=" w-full">
          <div className="navbar hidden md:block bg-[#ea7f23]">
            <nav className=" shadow  dark:bg-gray-800 text-[#334141] z-100 text-[14px] font-[400]">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center ml-[10px]">
                    <div className={styles.container}>
                      ...
                      <div className={styles.cardflip}>
                        <ul className="absolute bg-black shadow-sh-search w-[180px] text-center text-gray-700 group-hover:block ">
                    ...
                    <div className={styles.container}>
                      ...
                      {/* List inside shop */}
                      <div className={styles.cardflip}>
                        <ul className="absolute bg-white shadow-sh-search w-[600px] z-60 text-center text-gray-700 group-hover:block ">
                          <div className="inline-flex z-90">
