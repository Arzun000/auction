...
export const Headerone = () => {
  return (
    <nav className="bg-white shadow  dark:bg-gray-800 text-[#334141] text-[14px] font-[400]">
      <div className="max-w-[1400px] m-auto  py-[5px] md:flex md:items-center md:justify-between">
        <div className="flex items-center justify-between">
          <div className="lang-curr">
            <div className="group inline-block  relative">
              <button className="text-gray-700 py-2 mr-[5px] pr-[8px] border-r hover:text-[#ea7f23] inline-flex items-center">
