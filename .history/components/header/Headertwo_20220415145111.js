...
export const Headertwo = () => {
  ...
  return (
    <nav className="bg-white shadow  dark:bg-gray-800 text-[#334141] text-[14px] font-[400]">
      <div className=" max-w-[1400px] m-auto lg:py-4 ">
        <div className="hidden md:flex md:items-center md:justify-between">
          ...
          <div className="hidden md:flex items-center mt-4 md:mt-0">
            <div className="container-search text-[14px] float-left inline-flex m-auto">
              <div className="dropdown-button h-[40px] bg-white items-center pl-2 pr-2  pt-[8px] border-r-[1px] shadow-sh-search1 rounded-l-lgx ">
                <button
                  className="  text-sm px-6 py-[2px] outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                  type="button"
                  ref={btnDropdownRef}
                  onClick={() => {
                    dropdownPopoverShow
                ...
                >
                  <div className="inline-flex">
                    <div className="cat text-[14px] text-[#8f8c8c]">
                      Categories
                    </div>
