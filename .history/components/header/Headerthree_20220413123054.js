      ...
      <div className={navbarClasses.join(" ")}>
        <div className=" w-full">
          <div className="navbar hidden md:block  bg-[#ea7f23]">
            <nav className=" shadow items-center dark:bg-gray-800 text-[#334141] text-[14px] font-[400]">
              <div className="max-w-[1400px] h-[70px] md:flex md:items-center md:justify-between">
