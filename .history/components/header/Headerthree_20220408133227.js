        ...
        <div className=" w-full">
          <div className="navbar hidden md:block  bg-[#ea7f23]">
            <nav className=" shadow  dark:bg-gray-800 text-[#334141] text-[14px] font-[400]">
              <div className="mx-[5%] h-[70px]  md:flex md:items-center md:justify-between">
          ...
          <div className="flex md:hidden z-100 justify-between px-8  items-center">
            ...
            <div className="ml-[20px] pt-[12px] text-[20px] border-b-2">
              <button
