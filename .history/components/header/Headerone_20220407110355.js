...
export const Headerone = () => {
  return (
    <nav className="bg-white shadow mx-[10%] dark:bg-gray-800 text-[#334141] text-[14px] font-[400]">
      <div className="mx-[20px]   py-[5px] md:flex md:items-center md:justify-between">
