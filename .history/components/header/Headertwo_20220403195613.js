        ...
        <div className="hidden md:flex md:items-center md:justify-between">
          ...
          <div className="hidden md:flex items-center mt-4 md:mt-0">
            <div className="container-search text-[14px] float-left inline-flex m-auto">
              ...
              <form className="search-pro1 text-[14px] bg-red-400 h-[40px] w-[200px] lg:w-[400px] shadow-sh-search1 border-gray-200 focus:outline-none flex rounded-r-lgx items-center">
