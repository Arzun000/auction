    ...
    <>
      <div className="navbar hidden md:block bg-[#ea7f23]">
        <div className="flex flex-wrap">
          <div className="container navbar inline-flex m-auto  ">
            <div className="hidden md:flex md:w-4/5 items-center space-x-1">
              ...
              <div className={styles.container}>
                ...
                {/* List inside shop */}
                <div className={styles.cardflip}>
                  <ul className="absolute bg-white shadow-sh-search w-[600px] z-10 text-center text-gray-700 group-hover:block ">
                    <div className="inline-flex">
            ...
            <div className="md:w-1/5 pt-[20px] pl-[50px] text-white">
              <button>
                <Link href="#">
                  <b>Sign In</b>
                </Link>
