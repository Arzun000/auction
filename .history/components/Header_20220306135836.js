...
export const Header = () => {
  return (
    <>
      <topheader>
        <div className="header-top w-full md:px-[70px] flex-row md:inline-flex">
          <div className="header-top-container grid grid-cols-2 lg:grid-cols-4 md:gap-0 w-full ">
            <div className="top-cont-left inline-flex px-[2px] h-auto col-span-3  py-[2px] gap-1">
              ...
              <div className="w-auto h-auto hidden lg:block items-center">
              ...
              <div className="w-auto hidden lg:block  ">gg</div>
              <div className="w-auto hidden lg:block ">dd</div>
            </div>
