        ...
        <div className="flex flex-wrap">
          ...
          <div className="md:w-3/5 px-4">
            <div className="container-search text-[14px] float-left inline-flex m-auto">
              ...
              <form className="search-pro1 text-[14px] bg-white h-[40px] w-[180px] lg:w-[350px] shadow-sh-search1 border-gray-200 focus:outline-none flex rounded-r-lgx items-center">
          ...
          <div className="md:w-1/3 px-4">gg</div>
        </div>
      </div>
    </div>
  );
