      ...
      <top-container>
        <div className="top-container bg-slate-500">
          <div className="container m-auto py-2 flex bg-blue-300 md:flex-row">
            ...
            <div className="container-search inline-flex">
              ...
              <div className="cat-search">
                <div class="search-pro bg-gray-100 h-12 w-80 border-gray-200 inline-flex items-center">
                  <input
                    type="text"
                ...
                <div className="search-btn">
                  <button
                    class="py-2 px-4 bg-white text-gray-600 rounded-full 
