            ...
            <div className="canv-content ">
              ...
              <div className="main-content-btn">
                <button class="inline-flex items-center focus:outline-none text-base md:mt-2">
                  <div
                    className="auc-btn font-medium tracking-wide text-white
                   capitalize transition-colors duration-200 transform bg-blue-600
                    rounded-md hover:bg-blue-500 focus:outline-none focus:ring
