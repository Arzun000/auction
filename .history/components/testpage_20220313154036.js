    ...
    <div>
      <div class={styles.container}>
        ...
        <div class={styles.cardflip}>
          <ul class="absolute shadow-sh-search w-[180px] ease-in-out duration-1000 text-center text-gray-700 group-hover:block ">
        ...
        <header-nav>
          <div className="navbar bg-[#ea7f23]">
            ...
            "
              ...
              <div className="header-links ml-[2px] text-white md:mr-auto md:ml-4 md:pl-4 float-left lg:inline-flex m-auto">
                <div class={styles.container}>
                  <div class={styles.card}>Home</div>
                  <div class={styles.cardflip}>
                    <ul class="absolute shadow-sh-search w-[180px] ease-in-out duration-1000 text-center text-gray-700 group-hover:block ">
