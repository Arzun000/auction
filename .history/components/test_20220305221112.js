  ...
  return (
    <>
      <div className="header-top w-full px-[70px] inline-flex">
        <div className="header-top-container grid md:grid-cols-2 lg:grid-cols-4 md:gap-0 w-full bg-yellow-100">
          <div className="top-cont-left inline-flex px-[2px] h-auto col-span-3 bg-blue-400 py-[2px] gap-1">
            <div className="w-[130px] bg-gray-500 py-[10px] flex h-[auto]">
            ...
            <div className="w-auto bg-gray-400 h-auto invisible lg:visible items-center">
              <div className="header-top-contact-methods invisible lg:visible inline-flex py-[10px] ">
                <div className="header-top-contact-phone invisible">
                  Call us toll free: +40 712 345 678
                </div>
                <div className="header-top-contact-email invisible mx-4">
