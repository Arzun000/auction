          ...
          <div class="hidden md:flex items-center space-x-1">
            <div className="cat-dropdown bg-white p-2">
              ...
              >
                <a
                  href="#pablo"
                  className="text-sm py-2 px-4 font-normal block w-full bg-white whitespace-no-wrap text-black"
                ...
                <a
                  href="#pablo"
                  className="text-sm py-2 px-4 font-normal block w-full whitespace-no-wrap bg-white text-black"
                  onClick={(e) => e.preventDefault()}
                >
                  Another action
                </a>
                ...
                <a
                  href="#pablo"
                  className="text-sm px-4 font-normal block w-full whitespace-no-wrap bg-white text-black"
                  onClick={(e) => e.preventDefault()}
                >
                  Seprated link
                </a>
