  ...
  return (
    <>
      <div className="flex grid-cols-2 flex-row gap-4 my-[120px]">
        ...
        <div className="h-[500px] pt-[60px] pr-[30px] pl-[160px] -z-0 w-[90%] ml-[-120px] bg-green-800">
          <form className="space-y-4 text-gray-700 px-6" action="/">
            ...
            <button
              type="submit"
              className="py-[10px] w-auto text-sm text-white rounded-full border-[2px] border-[#ea7f23] bg-[#ea7f23]
