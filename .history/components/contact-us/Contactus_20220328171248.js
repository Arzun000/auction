  ...
  return (
    <>
      <div className="flex grid-cols-2 flex-row gap-4 my-[120px]">
        <div className="h-[380px] mt-[40px] ml-[22px] w-[320px] z-10 bg-[#ea7f23]">
          <div className="contact-info">
            <div className="text-secttl text-center mt-[50px]">Contact Us</div>
            <div className="contact-info-detail bg-blue-200 ml-[50px] mt-[20px]">
              <div className="section-subtitle text-[#817f7f] mt-[10px] text-[14px] inline-flex">
                <img
            ...
            <div className="flex flex-wrap">
              <div className="w-full">
                <textarea
                  id="message"
                  rows="4"
                  className="textarea bg-[#efefef] border-none rounded-[12px]"
