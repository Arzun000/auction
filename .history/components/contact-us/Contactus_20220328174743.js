  ...
  return (
    <>
      <div className="flex grid-cols-2 flex-row gap-4 my-[120px]">
        <div className="hidden lg:block h-[380px] mt-[40px] ml-[22px] w-[320px] z-10 bg-[#ea7f23]">
        ...
        <div className="h-[500px] pt-[60px] pr-[30px] pl-[160px] -z-0 lg:w-[90%] ml-[-120px] rounded shadow-2xl">
