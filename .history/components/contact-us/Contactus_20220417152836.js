...
export const Contactus = () => {
  return (
    <>
      <div className="flex grid-cols-2 relative flex-row max-w-[1400px] m-auto gap-4 my-[120px]">
        <div className="hidden lg:block absolute h-[380px] mt-[40px] ml-[22px] w-[320px]  bg-[#ea7f23]">
        ...
        <div className="h-[560px] lg:h-[500px] pt-[60px] pr-[30px] pl-[160px]  lg:w-[90%] ml-[-120px] rounded shadow-box-sh">
