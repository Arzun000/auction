    ...
    <>
      <canvas-bottom>
        <div className="can-btm-container">
          <div class="grid grid-rows-2 grid-cols-3 grid-flow-col gap-4 bg-blue-700 p-2">
            {/* image 1 */}
           ...
           hover:bg-yellow-500 hover:border-yellow-500 hover:text-white font-bold focus:z-10 focus:ring-2 focus:ring-blue-700
            ...
            {/* image-2 */}
            <div class="col-span-1 h-auto relative bg-yellow-400 w-auto">
              <div className="h-[175px] inline-flex">
                ...
                <div className="image-caption w-auto m-auto">
                  <div className="image-caption-one text-l ml-[20px] font-bold">
                    <p>
                      <center>VolksWagan Bus</center>
                    </p>
                  </div>
                  <div className="image-caption-two ml-[20px] pb-2">
                    Auction Ended
                    <div className="image-icons ml-6 inline-flex">
                      <div className="bid-now-icon rounded-full p-3  hover:bg-orange-500 mt-[2px]">
                      ...
                      <div className="heart-icon rounded-full p-3 hover:bg-orange-500">
                      ...
                      <div className="search-icon rounded-full p-3 hover:bg-orange-500">
                        <button className="inline-flex items-center focus:outline-none text-base md:mt-2">
                          <img
