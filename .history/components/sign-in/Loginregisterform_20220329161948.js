...
export const Loginregisterform = () => {
  ...
  const renderForm = (
    <div className="form mt-[30px]">
      ...
      >
        ...
        <div className="ml-0 bg-green-400">
          <button
            type="submit"
            className="py-[10px] px-[60px] ml-[-420px] text-sm  text-white rounded-full border-[2px] border-[#ea7f23] bg-[#ea7f23]
  ...
  return (
    <div className="flex grid-cols-2 flex-row gap-4 my-[120px]">
      ...
      <div className="register text-secttl  mt-[20px] w-[50%] text-white">
        <div className="text-secttl  mt-[20px] bg-gray-500 text-black">
          Register
