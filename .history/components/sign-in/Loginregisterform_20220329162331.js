...
export const Loginregisterform = () => {
  ...
  const renderForm = (
    <div className="form mt-[40px] ">
      ...
      <form
        className="space-y-4 text-gray-700 border-2 ml-[40px] px-6 pb-[80px]"
        action="/"
      >
        ...
        <button
          type="submit"
          className="py-[10px] px-[60px] text-sm text-white rounded-full border-[2px] border-[#ea7f23] bg-[#ea7f23]
