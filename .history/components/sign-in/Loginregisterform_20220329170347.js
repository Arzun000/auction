...
export const Loginregisterform = () => {
  ...
  return (
    <div className="flex grid-cols-1 lg:grid-cols-2 flex-row gap-16 mt-[10px]">
      <div className="login text-secttl mt-[20px] lg:w-[50%] ">
        {/* Login form */}
      ...
      <div className="register text-secttl  mt-[20px] mr-[40px] w-[50%] ">
        <div className="text-secttl text-center mt-[20px] text-black">
          Register
        </div>
