  ...
  const renderForm = (
    <div className="form mt-[30px]">
      ...
      <form
        ...
        action="/"
      >
        <div className="w-[80%] px-2 mt-[20px] text-left">
          <label className="section-subtitle text-[#000000]  mt-[10px] text-[12px]">
            Your Name or email adderss{" "}
            <span style={{ color: "#ea7f23" }}>*</span>
          </label>
          <input
            className="w-full h-10 px-3 border-[1px] rounded-full focus:outline-none focus:border-[#302e2c] focus:border-b-[1px] "
            type="text"
