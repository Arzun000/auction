  ...
  return (
    ...
    <>
      ...
      <header className="text-gray-600 body-font h-6">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center bg-[#ea7f23] ">
          <div className="dropdown-button h-max w-24">
            <button class="inline-flex items-center bg-gray-100 border-0 py-1 h-auto focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
              Button
              <svg
                fill="none"
                stroke="currentColor"
