          ...
          <div className="container navbar  m-auto flex  md:flex-row">
            ...
            <div className="header-links ml-[2px] hidden text-white md:mr-auto md:ml-4 md:pl-4 float-left lg:inline-flex m-auto">
              ...
              <div class="group inline-block  relative">
                ...
                <ul class="absolute hidden bg-white shadow-sh-search w-[250px] ease-in-out duration-1000 text-center text-gray-700 group-hover:block">
                  <div className="inline-flex">
                    ...
                    <div className="shop-menu-mid">Wearable</div>
                    <div className="shop-menu-right">Wearable</div>
                  </div>
                </ul>
              </div>
