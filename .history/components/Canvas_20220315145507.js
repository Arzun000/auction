    ...
    <>
      <canvas-top>
        <div className="canv-top-container">
          ...
          <div className="canv-container absolute mt-[-240px] ml-[-60px] lg:mt-[-550px] lg:ml-[0] left-[5rem] flex  h-[16rem] w-[34rem] ">
            <div className="canv-content">
              <div className="main-content-title ">
                <p className="canvas-text">Find your dream car</p>
              </div>
              <div className="main-content-subtitle">
                <p className="canvas-subtext">& give it a try</p>
              </div>
              <div className="canvas-subtitle truncate mt-2">
