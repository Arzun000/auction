      ...
      <footer-links>
        <div className="footer-link-container grid bg-[#c5c4c1] mt-[1px] h-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 w-full">
          ...
          <div className="links bg-red-500">
            ...
            <div className="links-container bg-blue-300 mx-[80px] ">
              <div className="link-one text-l ml-[20px] bg-gray-500 flex-row">
                <a
                  href="#"
                  class="no-underline text-[#5a5957] hover:text-[#a19e9b]"
                >
                  <div className="bg-green-300 w-2">
                    <img
                  ...
                  <div className="bg-green-300 w-[120px]">Mobile Phones</div>
                </a>
              </div>
