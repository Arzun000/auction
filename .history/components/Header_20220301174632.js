      ...
      <topheader>
        <div className="header-top bg-slate-500 h-10">
          <div className="container m-auto py-2 flex bg-yellow-500 md:flex-row   ">
            ...
            <div className="absolute float-right top-2 right-2 inline-flex ">
              <div className="order float-right bg-blue-800 inline-flex">
                <img src="/static/icons/truck.png" height={15} width={15}></img>
                Order Tracking
              </div>
              <div className="wish inline-flex float-right">
