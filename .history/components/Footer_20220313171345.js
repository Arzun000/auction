...
export const Footer = () => {
  return (
    <>
      ...
      <footer-links>
        <div className="footer-link-container grid bg-gray-200  mt-[1px] h-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 w-full">
          ...
          <div className="links ">
            ...
            <div className="links-container text-[#afafaf] mx-[80px] ">
              <div className="link-one text-l ml-[20px] mt-2 flex">
                <div className="">
                  <img
          ...
          <div className="policy">
            ...
            <div className="links-container  mx-[80px] ">
              <div className="link-one text-l ml-[20px] flex">
                <div className="">
                  <img
                    src="/static/icons/double_right.png"
