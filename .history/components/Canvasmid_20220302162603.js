        ...
        <div className="canvas-cards">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6 p-5 pb-6">
            <div className="h-[250px] bg-blue-200 w-150">
              <div className="image-texts ml-6 absolute  ">
                <div className="bid-now-icon rounded-full bg-yellow-500 hover:bg-yellow-500 mt-[2px]">
                ...
                <div className="heart-icon rounded-full  hover:bg-yellow-500">
                  <button class="inline-flex items-center focus:outline-none text-base md:mt-2">
                    <img
                ...
                <div className="search-icon rounded-full  hover:bg-yellow-500">
                  <button class="inline-flex items-center focus:outline-none text-base md:mt-2">
                    <img
