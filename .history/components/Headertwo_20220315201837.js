        ...
        <div className="top-container  ">
          <div className="container m-auto py-2 flex  md:flex-row">
            ...
            <div className="container-search hidden text-[14px] float-left lg:inline-flex m-auto">
              ...
              <div className="search-pro1 text-[14px] bg-white h-[40px] w-[220px] shadow-sh-search1 border-gray-200 focus:outline-none flex rounded-r-lgx items-center">
                {/* <div className="input-text"> */}
                <input
                  type="text"
                  placeholder="Search Products..."
                  className="bg-transparent text-gray-600 text-[14px] px-4 focus:outline-none w-full"
