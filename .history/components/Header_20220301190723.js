          ...
          <div className="flex flex-row justify-between">
            ...
            <div className="container-search">
              <div class="bg-gray-100 rounded border border-gray-200 flex items-center">
                <button class="py-2 px-4 bg-white text-gray-600 rounded-l border-r border-gray-200 hover:bg-gray-50 active:bg-gray-200 disabled:opacity-50 inline-flex items-center focus:outline-none">
                  Search
                </button>{" "}
                <input
                  type="text"
              ...
              <div class="bg-gray-100 rounded border border-gray-200 flex items-center justify-between">
                <input
                  type="text"
                  placeholder="Email"
                  value="jack@frontier.com"
                  class="bg-transparent py-1 text-gray-600 px-4 focus:outline-none w-full"
                />{" "}
                <button class="py-2 px-4 bg-white text-gray-600 rounded-r border-l border-gray-200 hover:bg-gray-50 active:bg-gray-200 disabled:opacity-50 inline-flex items-center focus:outline-none">
                  Submit
                </button>
              </div>
            </div>
