    ...
    <>
      <topheader>
        <div className="header-top w-full px-[70px] inline-flex">
          <div className="header-top-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 w-full ">
            <div className="top-cont-left lg:inline-flex px-[2px] col-span-3 py-[2px] ">
              ...
              <div className="w-auto h-auto invisible lg:visible items-center">
