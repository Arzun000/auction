        ...
        <div className="top-container  ">
          <div className="container m-auto py-2 flex  md:flex-row">
            ...
            <div className="container-search hidden float-left lg:inline-flex m-auto">
              ...
              <div className="search-pro1 bg-white h-[42px] shadow-sh-search1 border-gray-200 focus:outline-none flex rounded-r-lgx items-center">
                <input
                  type="text"
                  placeholder="Search Products..."
                  className="bg-transparent border-none text-gray-600 px-4 focus:outline-none w-full"
                />
              </div>
