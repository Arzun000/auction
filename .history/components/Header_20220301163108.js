          ...
          <div className="container m-auto py-2 flex bg-yellow-500 md:flex-row   ">
            <div className="row-top-header items-center">
              <div className="flex flex-row ">
                ...
                <div className="currency-box w-20 items-center pl-2 inline-flex">
                  EUR
                  <img
                    src="/static/icons/expand_arrow.png"
                    height={15}
                ...
                <div className="header-top-contact-methods">
                  <div className="header-top-contact-phone">
                    {" "}
                    EUR Call us toll free: +40 712 345 678
                  </div>
                  <div className="header-top-contact-email"></div>
                </div>
              </div>
