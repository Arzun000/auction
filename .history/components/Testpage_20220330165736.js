  ...
  return (
    <>
      <div className="lg:flex grid-cols-1 lg:grid-cols-2 flex-row gap-16 mt-[10px] mb-[40px]">
        <div className="car1 mt-[20px] ml-[40px] lg:w-[50%] ">
          <div
            className="w-full h-[400px] absolute bg-cover bg-blue-200 bg-center  "
            // style={{
            //   backgroundImage: 'url("/images/supercar1.jpg")',
            //   backgroundRepeat: "no-repeat",
            // }}
          >
            <div className="car-border relative h-[20px] bg-red-400 "></div>
          </div>
        </div>
