    ...
    <>
      <div className="top-container ">
        <div className="container m-auto py-2 flex  md:flex-row">
          ...
          <div className="container-search mt-10  inline-flex m-auto">
            <div className="cat-list ">
              <div className="dropdown-button h-12  w-50 pt-2 pl-2 pr-2 shadow-2xl bg-white rounded-l-lgx">
            ...
            <div className="cat-search  shadow-2xl inline-flex">
