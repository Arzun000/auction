        ...
        <div className="container navbar  m-auto flex  md:flex-row">
          <div class="hidden md:flex items-center space-x-1">
            <div className="cat-dropdown bg-white p-2">
              <button
                className=" font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 bg-blueGray-500 active:bg-blueGray-600 ease-linear transition-all duration-150"
                type="button"
                ref={btnDropdownRef}
                onClick={() => {
                  dropdownPopoverShow
