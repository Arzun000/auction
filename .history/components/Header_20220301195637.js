          ...
          <div className="container m-auto py-2 flex bg-blue-300 md:flex-row">
            ...
            <div className="container-search">
              <div className="cat-list">
                <div className="dropdown-button h-12 w-60 pl-2 pr-2 bg-white rounded-l-lgx">
                  <button class="inline-flex items-center justify-between focus:outline-none text-base md:mt-2">
                    CATEGORIES
                    <img
                      src="/static/icons/expand_arrow.png"
                      height={15}
              ...
              <div className="cat-search">d</div>
            </div>
          </div>
        </div>
      </top-container>
