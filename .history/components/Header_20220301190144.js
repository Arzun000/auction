        ...
        <div className="container-top bg-green-500 ">
          <div className="flex flex-row justify-between">
            ...
            <div className="container-search">
              {" "}
              <div class="flex flex-col p-1 overflow-hidden border rounded-lg dark:border-gray-600 lg:flex-row dark:focus-within:border-blue-300 focus-within:ring focus-within:ring-opacity-40 ">
                <input
