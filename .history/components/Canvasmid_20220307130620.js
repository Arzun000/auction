    ...
    <>
      ...
      <canvasmidcards>
        <div className="canvas-cards ">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 bg-green-300 md:gap-4 lg:gap-4 p-5 pb-6">
            {/* Item 1 */}
            <div className="h-[250px] w-150">
              ...
              <div className="image-caption text-center bg-gray-100">
                ...
                <div className="image-caption-two p-2">Current Bid: $100</div>
              </div>
            </div>
            {/* item 2 */}
